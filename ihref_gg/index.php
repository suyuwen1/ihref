...
<div id="main">
	<div id="top">
		<ul>
			...
			<li class="img" id="img3"><a target="_blank" href="#"><img src="img/3.jpg" alt=""></a></li>
			<li class="img" id="img4"><a target="_blank" href="#"><img src="img/3.jpg" alt=""></a></li>
			<li class="img" id="img5"><a target="_blank" href="#"><img src="img/3.jpg" alt=""></a></li>
		</ul>
	</div>
	<div id="down">
		<ul>
			...
			<li class="list" i="2"><span class="bt"><a target="_blank" href="http://redirect.simba.taobao.com/rd?w=unionnojs&f=http%3A%2F%2Fai.taobao.com%2Fauction%2Fedetail.htm%3Fe%3DfwrzGw19Pkq6k0Or%252B%252BH4tMBwlXCfbg2ZsmieqIX6sfqLltG5xFicOdXrTUTgh9sMDPIwxrc30rigOQv3H5R7StZ0c10rey9RLHhnGHvY3HwOvWWTr%252Bpe7m3abJM7sDg23aBtcmGUhOUT%252FZKykqpE2g%253D%253D%26ptype%3D100010%26from%3Dbasic&k=5ccfdb950740ca16&c=un&b=alimm_0&p=mm_33209569_8104433_28016185">小米手机4</a></span><span class="jg">¥ 2098</span></li>
			<li class="list" i="3"><span class="bt"><a target="_blank" href="#"></a></span><span class="jg">广告位</span></li>
			<li class="list" i="4"><span class="bt"><a target="_blank" href="#"></a></span><span class="jg">广告位</span></li>
			<li class="list" i="5"><span class="bt"><a target="_blank" href="#"></a></span><span class="jg">广告位</span></li>
		</ul>
	</div>
</div>
</body>
