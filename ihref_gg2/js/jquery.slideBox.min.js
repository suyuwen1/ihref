(function($) {
	$.fn.slideBox = function(options) {
		...
		var init = function() {
			...
			if (!settings.hideBottomBar) {
				...
				var title = $('<div class="title"></div>').html(function() {
					...
					return $('<a>').attr({'href':href,'target':'_blank'}).text(text)
				}).appendTo(tips);
				...
				lis.each(function(i, n) {
					...
					$('<a>').attr({'href':'javascript:(void)'}).text(text).addClass(css).css('borderRadius', settings.clickBarRadius + 'px').click(function() {
		...
		var start = function() {
			...
			wrapper.find('.title').find('a').attr({'href':active_a.attr('href'),'target':'_blank'}).text(active_a.attr('title'));
